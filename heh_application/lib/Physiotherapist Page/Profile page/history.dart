...
import '../../Member page/Service Page/Payment page/billChoose.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: FutureBuilder <List<BookingDetail>>(
          future: CallAPI().GetAllBookingDetailByPhysioID(sharedPhysiotherapist!.physiotherapistID),
              ...
              if (snapshot.data!.isNotEmpty){
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    String day = DateTimeFormat.formatDate(snapshot.data![index].bookingSchedule!.schedule!.slot!.timeStart);
                    String start = DateTimeFormat.formateTime(snapshot.data![index].bookingSchedule!.schedule!.slot!.timeStart);
                    String end = DateTimeFormat.formateTime(snapshot.data![index].bookingSchedule!.schedule!.slot!.timeEnd);
                    ...
                    name: snapshot.data![index].bookingSchedule!.schedule!.typeOfSlot!.typeName,
                    date: day,
                    time: "$start - $end",
                    bookedFor: snapshot.data![index].bookingSchedule!.subProfile!.subName,
                    press: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
