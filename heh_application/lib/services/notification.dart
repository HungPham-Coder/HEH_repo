  ...
  Future<void> createTestNotification() async {
    await AwesomeNotifications().createNotification(
        content: NotificationContent(
          ...
          title: '${Emojis.emotion_blue_heart + Emojis.emotion_heart_decoration}',
            body: 'Test Notification',
          bigPicture: 'https://firebasestorage.googleapis.com/v0/b/healthcaresystem-98b8d.appspot.com/o/image%2Fwelcome2.png?alt=media&token=e26f1d4f-e548-406c-aa71-65c099663f85',
