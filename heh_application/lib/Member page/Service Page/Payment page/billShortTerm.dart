...
class BillShortTermPage extends StatefulWidget {
  BillShortTermPage({
    Key? key,
  ...
  String? view;
  @override
  State<BillShortTermPage> createState() => _BillShortTermPageState();
}

class _BillShortTermPageState extends State<BillShortTermPage> {
  String? day;
  String? timeStart;
  String? timeEnd;
  bool check = false;
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              information(
                                  name: "ID: ",
                                  info: widget.schedule.scheduleID),
                              padding(),
                              information(
